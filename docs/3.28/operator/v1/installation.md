---
permalink: /3.28/operator/v1/installation/
---
...
"Name is an enum which identifies the csi-node-driver DaemonSet container by name. Supported values are: csi-node-driver"
